      ...
      a +=
        ...
        f.map
          .call(e.attributes, function (e) {
            return (
              " " + e.nodeName + '="' + B(e.value).replace(/"/g, "&quot;") + '"'
            );
          })
          .join("") +
        ">";
  ...
  function S(n, i, a, e) {
    ...
    function s(e) {
      ...
      if (r) {
        var a = E;
        for (
          a.skip ? (p += n) : (a.rE || a.eE || (p += n), o(), a.eE && (p = n));
          E.cN && (R += C),
            E.skip || E.sL || (v += E.relevance),
            (E = E.parent) !== r.parent;
    ...
    function t(e, n) {
      ...
      if ("illegal" === n.type && !a)
        throw new Error(
          'Illegal lexeme "' + t + '" for mode "' + (E.cN || "<unnamed>") + '"'
        );
      if ("end" === n.type) {
        var r = s(n);
        if (null != r) return r;
